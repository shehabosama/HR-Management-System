 ...
 * @author bebo2
 */
public class frmProjectsReports extends javax.swing.JFrame {

    /**
     * Creates new form frmDepartmrnReports
     */
    public frmProjectsReports() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblProjects.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Project Number", "Project Name", "Project Location", "department number", "department name"
            }
        ));
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            MessageFormat footer = new MessageFormat("Page - {0}");
             tblProjects.print(JTable.PrintMode.FIT_WIDTH,header,footer);
             
        } catch (PrinterException ex) {
            Logger.getLogger(frmProjectsReports.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnPrintActionPerformed

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        
        db.go.fillToJTable("project_data", tblProjects);
        tblProjects.getTableHeader().setBackground(Color.gray);
        tblProjects.getTableHeader().setForeground(Color.WHITE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmProjectsReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmProjectsReports().setVisible(true);
            }
        });
    }
