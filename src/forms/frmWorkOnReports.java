 ...
 * @author bebo2
 */
public class frmWorkOnReports extends javax.swing.JFrame {

    /**
     * Creates new form frmDepartmrnReports
     */
    public frmWorkOnReports() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblWorlon = new javax.swing.JTable();
        ...
        tblWorlon.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Employee Number", "Employee Name", "Department Number", "Department Name"
            }
        ));
        jScrollPane1.setViewportView(tblWorlon);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            MessageFormat footer = new MessageFormat("Page - {0}");
             tblWorlon.print(JTable.PrintMode.FIT_WIDTH,header,footer);
             
        } catch (PrinterException ex) {
            Logger.getLogger(frmWorkOnReports.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnPrintActionPerformed

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        
        db.go.fillToJTable("work_on_data", tblWorlon);
        tblWorlon.getTableHeader().setBackground(Color.gray);
        tblWorlon.getTableHeader().setForeground(Color.WHITE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmWorkOnReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmWorkOnReports().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblWorlon;
